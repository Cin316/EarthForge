...
public class Air extends Block {
	...
	//Image is blank.
	public static Image image = new BufferedImage(Execute.tileWidth, Execute.tileHeight, BufferedImage.TYPE_INT_ARGB);
	//CollisionBox is empty.
	public static CollisionBox collide = new CollisionBox(Execute.tileWidth, Execute.tileHeight, false);
